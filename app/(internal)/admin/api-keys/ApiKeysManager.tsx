...
/**
 * The body of the API Keys screen. Lives beside the route rather than in
 * components/ because exactly one page renders it — same as orders/ViewToggle.
 *
 * Split out of page.tsx so that page.tsx can be a server component and hold the
 * admin gate. As one client component it had no server-side check at all: the
 * only thing above it was the (internal) layout, which admits any team member.
 */
